...
;MULTIPLEXADO	    MOVF    TMPR_CENTENA,W
;		    CALL    TABLA
;		    MOVWF   PORTD
;		    MOVLW   b'00001000'
;		    MOVWF   PORTC
...
RESET_TMPR	    CALL    PRESSED
		    ...
		    MOVWF   TMPR_MAX
		    BCF	    INTCON,RBIF	    ;LIMPIAR BANDERA
...
BUZZER_OFF	    BCF	    TRISE,TRISE2
		    GOTO    IO_BUZZER_EXIT
IO_BUZZER_EXIT	    BCF	    INTCON,RBIF	    ;LIMPIAR BANDERA
		    BANKSEL PORTB
		    CLRF    PORTB	    ;DEVOLVER PUERTO B A ESTADO ORIGINAL
		    GOTO    ISR_EXIT
...
RX_ON		    BSF	    RCSTA,CREN
		    ...
		    MOVWF   TMPR_SIM
		    GOTO    RX_ENABLE_EXIT
RX_ENABLE_EXIT	    BCF	    INTCON,RBIF	    ;LIMPIAR BANDERA
		    CLRF    PORTB	    ;DEVOLVER PUERTO B A ESTADO ORIGINAL
		    GOTO    ISR_EXIT
